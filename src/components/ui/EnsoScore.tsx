...
export function EnsoScore({
  ...
  return (
    <div className="flex flex-col items-center gap-1.5">
      {/* Label sits outside the ring - inside, at this size, "Your score"
          is wider than the chord below center and visually overlapped the
          arc. The ring only ever has to fit the (short) number now. */}
      <div
